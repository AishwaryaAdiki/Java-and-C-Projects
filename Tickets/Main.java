package Tickets; // packages are usually named in lowercase, but the project documentation says that the name should be "Tickets"
import java.io.File;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            Scanner count = new Scanner(new File("src/Tickets/A1.txt"));
        ...
        try {
            Scanner scanner = new Scanner(new File("src/Tickets/A1.txt"));
    ...
    public static void WriteBackToFile(int length, int count_lines, String[][] finalReserve) throws IOException {
        ...
        FileOutputStream outputStream = new FileOutputStream("src/Tickets/A1.txt");
